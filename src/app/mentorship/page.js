...
import { mentors } from "@/ai/mentor/mentorData";
import { calculateMentorScore } from "@/ai/mentor/mentorScoring";
...
export default function MentorshipPage() {
  const rankedMentors = mentors
    .map(m => ({
      ...m,
      score: calculateMentorScore(studentProfile, m)
    }))
    .sort((a, b) => b.score - a.score);

  return (
    <div className="p-10">
      <h1 className="text-3xl font-bold mb-6">AI Mentor Recommendations</h1>
